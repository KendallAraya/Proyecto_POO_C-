<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla.Master" AutoEventWireup="true" CodeBehind="Pacientes.aspx.cs" Inherits="Sitio_Web.Pacientes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentMainHolder1" runat="server">
    <div>
            ...
            <asp:Button ID="btnBuscar" runat="server" Text="Buscar" class="btn btn-primary m-2" OnClick="btnBuscar_Click" />
            <asp:Button ID="btnGuardar" runat="server" Text="Nuevo cliente" class="btn btn-primary m-2" OnClick="btnGuardar_Click" />
            <hr />  
            <asp:GridView ID="grdLista" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No existen registros para mostrar" ForeColor="#333333" GridLines="None" Width="100%" PageSize="8" OnPageIndexChanging="grdLista_PageIndexChanging">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="DireccionP" HeaderText="Direccion" />
                     <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkMoficar" runat="server" CommandArgument='<%# Eval("IdPaciente").ToString() %>' CommandName="Modificar" OnCommand="lnkMoficar_Command">Modificar</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkEliminar" runat="server" CommandArgument='<%# Eval("IdPaciente").ToString() %>' CommandName="Eliminar" OnCommand="lnkEliminar_Command">Eliminar</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
